...
SELECT setval('tour_id_seq', (SELECT MAX(id) FROM tour), true);
SELECT setval('activity_seq', (SELECT MAX(id) FROM activity), true);
SELECT setval('trip_seq', (SELECT MAX(id) FROM trip), true);